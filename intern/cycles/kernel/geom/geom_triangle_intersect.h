                                          ...
                                          int triAddr)
{
	...
	const float Ay = IDX(A, ky) - Sy * A_kz;
	const float Bx = IDX(B, kx) - Sx * B_kz;
	const float By = IDX(B, ky) - Sy * B_kz;
	const float Cx = IDX(C, kx) - Sx * C_kz;
	const float Cy = IDX(C, ky) - Sy * C_kz;
